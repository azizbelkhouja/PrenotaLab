          ...
          <Grid container spacing={3} style={{ padding: 20 }}>
            {user && user.name && (
              <Grid item className={classes.hideOnSmall}>
                <Typography className={classes.bannerTitle}>Nome</Typography>
            ...
            <Grid item>
              <Typography className={classes.bannerTitle}>Passi</Typography>
              {selectedSeats > 0 ? (
                <Typography className={classes.bannerContent}>
                  {selectedSeats} passi
                </Typography>
            ...
            <Grid item>
              <Typography className={classes.bannerTitle}>Prezzo</Typography>
              <Typography className={classes.bannerContent}>
