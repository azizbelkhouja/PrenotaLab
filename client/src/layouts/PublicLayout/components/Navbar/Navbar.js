      ...
      <Fragment>
        <nav
          ...
          <div className={classes.navLinks}>
            ...
            <Link className={classes.navLink} to="/seminario/category/nowShowing">
              Seminari
            </Link>
            <Link className={classes.navLink} to="/seminario/category/comingSoon">
              Prossimamente
            </Link>
            <Link className={classes.navLink} to="/labs">
              Laboratori
            </Link>
          </div>
        ...
        <div
          ...
          <div className={classes.navContent}>
            <div className={classes.currentPageShadow}>Seminari</div>
            <ul
